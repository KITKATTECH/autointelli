...
const TableHeaders = [
 ...
 class TopExternalandInternal extends React.Component {
  constructor(props) {
    super(props)
  ...
  render() {
    return (      
        ...
        Top Internal / External port utilization details and comparison with previous day
                </div>
        <Card>
      <CardBody>
        <Nav tabs>
    ...
    export default TopExternalandInternal